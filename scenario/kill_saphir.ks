...
[tb_start_text mode=1 ]
#德比伦
[font face="DZUYOKU"][font size=75]喂！[r]
快想办法对付这家伙！[p]
...
[font face="KaiseiDecol-Bold"]没错[resetfont]……总之[font face="KaiseiDecol-Bold"]我的完美从未停歇，[resetfont]一直在不断地进化中。[p]
[_tb_end_text]
...
你这种渣渣给秒[c]杀[_c]掉啦～♥[font size=25][wait time=300]　嘛、[wait time=100]虽然对你也不是很了解啦。[resetfont][p]
...
#德比伦
啊～，嘛，没错！[r]
就是如此。[font size=25]哈啊～，这下可真麻烦了～[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
要是吸完后，连本大爷都变成他那种脑回路清奇的怪物，[r]
该如何是好！[wait time=300]哎～，这个点也别无它法了……，要上了！[p]
...
[tb_start_text mode=1 ]
#萨菲尔
最后，[emb exp="f.name"]……，我从你身上感受到了[r]
[font face="KaiseiDecol-Bold"]心灵[resetfont]的[font face="KaiseiDecol-Bold"]污秽[resetfont]。切莫懈怠了自我的修炼。[p]
